...
struct transport_node {
    ...
    /* base methods */
    int  (* sendto_port) (struct transport_node * this, int port, const void * src,
                          int len);
    int  (* block_port) (struct transport_node * this, int port ,
                         const vlan_t * exclude);
    int  (* release_port) (struct transport_node * this, int port ,
                           const vlan_t * exclude);
    int  (* refresh_fdb) (struct transport_node * this);
    int  (* judge_frame_type) (struct transport_node * this, const void * frame,
                               int * port);
};
...
int transport_node_sendto_port (struct transport_node *, int port,
                                const void * src, int len);
int transport_node_block_port (struct transport_node *, int port ,
                               const vlan_t * exclude);
int transport_node_release_port (struct transport_node *, int port ,
                                 const vlan_t * exclude );
...
int transport_node_judge_frame_type (struct transport_node *,
