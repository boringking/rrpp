...
struct major_node {
    ...
    /* 类方法 */
    int  (* sendto_port) (struct major_node * this, int port, const void * src,
                          int len);
    int  (* block_port) (struct major_node * this, int port ,
                         const vlan_t * exclude);
    int  (* release_port) (struct major_node * this, int port ,
                           const vlan_t * exclude);
    int  (* refresh_fdb) (struct major_node * this);
    int  (* judge_frame_type) (struct major_node * this, const void * frame,
                               int * port);
...
int major_node_sendto_port (struct major_node *, int port, const void * src,
                            int len);
int major_node_block_port (struct major_node *, int port ,
                           const vlan_t * exclude);
int major_node_release_port (struct major_node *, int port ,
                             const vlan_t * exclude);
...
int major_node_judge_frame_type (struct major_node *, const void * frame,
                                 int * port);
